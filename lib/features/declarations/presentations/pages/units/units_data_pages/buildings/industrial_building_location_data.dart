...
class IndustrialBuildingLocationData extends StatefulWidget {
  const IndustrialBuildingLocationData({
    super.key,
    required this.index,
  ...
  @override
  State<IndustrialBuildingLocationData> createState() =>
      _IndustrialBuildingLocationDataState();
}

class _IndustrialBuildingLocationDataState
    extends State<IndustrialBuildingLocationData> {
  ...
  void initState() {
    ...
    final building = cubit.industrialBuildings[widget.index];
    ...
    return Material(
      child: AppScaffold(
        title: widget.index == 0
            ? 'وصف المبنى الرئيسي للمنشأة الصناعية'
            : 'وصف مباني المنشأة الصناعية',
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          AppDropdownField<String>(
                            ...
                            items: cubit.lookups.buildingTypes
                                .map((b) => appDropDownOption(label: b.name))
                                .toList(),
                            onChanged: (v) =>
                                setState(() => building.buildingType = v),
                            validator: (v) =>
                          ...
                          AppTextFormField(
                            ...
                            controller: building.constructionDate,
                            readOnly: true,
                            onTap: () async {
                              ...
                              if (picked != null) {
                                setState(() {
                                  building.constructionDate.text =
                    ...
                    children: [
                      Expanded(
                        ...
                        child: SubmitDeclarationButton(
                          ...
                          withIcon: false,
                          onSubmit: () async {
                            final saved = await cubit.saveIndustrialBuilding(
                              widget.index,
                            );
                      ...
                      Expanded(
                        ...
                        child: CancelDeclarationButton(
                          ...
                          onCancel: () async {
                            if (widget.isNew) {
                              await cubit.deleteIndustrialBuilding(
                                widget.index,
                              );
                            }
